...
class Customers
{
     ...
     *
     * @param \KTU\CoreBundle\Entity\Employees $salesrepemployeenumber
     * @return Customers
     */
    public function setSalesrepemployeenumber(\KTU\CoreBundle\Entity\Employees $salesrepemployeenumber = null)
    {
